        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="border overflow-hidden transition-all hover:shadow-lg flex flex-col justify-between ${rounded} ${shadow}" style="border-color: ${tokens.primaryColor}15; background: ${tokens.backgroundColor};">
            ...
            <div class="p-5 flex-1 flex flex-col justify-between">
              ...
              <button class="w-full py-2 border text-xs font-semibold hover:bg-slate-50 transition-colors ${rounded}" style="border-color: ${tokens.primaryColor}; color: ${tokens.primaryColor};">
                Buy Item
              </button>
            </div>
          </div>`).join('\n')}
