  ...
  pages: [
    {
      ...
      components: [
        ...
        },
        {
          ...
          styles: {},
          fields: {
            title: `Welcome to ${newSiteName}`,
            subtitle: "Build your dream website with BRIXO",
            ctaText: "Get Started",
            imageUrl:
...
<div className="flex lg:hidden items-center justify-between mb-6">
  ...
  console.log("_ID:", (proj as any)._id);

  deleteProject((proj as any).id || (proj as any)._id);
}}
