...
// Products block with real Add to Cart functionality
const ProductsBlockWithCart = ({
  comp,
  tokens,
  onUpdateText,
  headingFont,
            ...
            >
              ...
              <div className="p-4 flex flex-col justify-between">
                ...
                <button
                  ...
                  className={`w-full py-1.5 border text-[11px] font-semibold ${rounded} flex items-center justify-center gap-1.5 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-colors`}
                  style={{ borderColor: tokens.primaryColor, color: tokens.primaryColor }}
                >
