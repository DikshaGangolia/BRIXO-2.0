...
export const useBuilderStore = create<BuilderState>((set, get) => ({
    ...
    if (type === 'Navbar') {
      ...
      defaultFields = {
        ...
        items: [
          ...
          { name: 'Leather Boots', price: '$129.99', image: 'https://images.unsplash.com/photo-1520639888713-7851133b1ed0?auto=format&fit=crop&w=400&q=80', desc: 'Handcrafted premium leather.' },
          { name: 'Cotton Hoodie', price: '$49.99', image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?auto=format&fit=crop&w=400&q=80', desc: 'Warm and cozy for winter.' }
        ]
      };
  ...
  saveActiveProject: () => {
    ...
    // Trigger auth store to update local storage
    useAuthStore.getState().updateProject(activeProject);
  }
}));
